...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Supplier.fax'
        db.add_column('inventory_supplier', 'fax', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Supplier.fax'
        db.delete_column('inventory_supplier', 'fax')
