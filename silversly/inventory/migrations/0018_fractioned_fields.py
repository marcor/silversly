...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.denominator'
        db.add_column('inventory_product', 'denominator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='multiple_set', null=True, to=orm['inventory.Product']), keep_default=False)

        # Adding field 'Product.factor'
        db.add_column('inventory_product', 'factor', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.denominator'
        db.delete_column('inventory_product', 'denominator_id')

        # Deleting field 'Product.factor'
        db.delete_column('inventory_product', 'factor')
    ...
    models = {
        ...
        'inventory.product': {
            ...
            'denominator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'multiple_set'", 'null': 'True', 'to': "orm['inventory.Product']"}),
