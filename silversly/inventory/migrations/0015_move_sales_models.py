...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'inventory.incomingproduct': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_base_price': ('common.models.FixedDecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '3'}),
        ...
        'inventory.newprice': {
            ...
            'value': ('common.models.FixedDecimalField', [], {'null': 'True', 'max_digits': '7', 'decimal_places': '2'})
        },
        'inventory.price': {
