...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Price'
        db.create_table('inventory_price', (
            ...
            ('markup', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
        ...
        db.send_create_signal('inventory', ['Price'])

        # Adding unique constraint on 'Price', fields ['pricelist', 'product']
        db.create_unique('inventory_price', ['pricelist_id', 'product_id'])

        # Adding field 'Pricelist.default_method'
        db.add_column('inventory_pricelist', 'default_method', self.gf('django.db.models.fields.CharField')(default='%=', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'Price', fields ['pricelist', 'product']
        db.delete_unique('inventory_price', ['pricelist_id', 'product_id'])

        # Deleting model 'Price'
        db.delete_table('inventory_price')

        # Deleting field 'Pricelist.default_method'
        db.delete_column('inventory_pricelist', 'default_method')
    ...
    models = {
        ...
        'inventory.ddt': {
            ...
            'shipping_address': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'shipping_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 19, 15, 22, 37, 741000)'})
        },
        'inventory.invoice': {
        ...
        'inventory.price': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'markup': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
