...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('inventory_product', 'updated',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 1, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.updated'
        db.delete_column('inventory_product', 'updated')
    ...
    models = {
        ...
        'inventory.product': {
            ...
            'updated': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 1, 1, 0, 0)'})
        },
        'inventory.supply': {
