...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('inventory_product', 'updated', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Product.updated'
        db.alter_column('inventory_product', 'updated', self.gf('django.db.models.fields.DateField')())
