...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('inventory_incomingproduct', 'new_base_price', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'IncomingProduct.new_base_price'
        db.delete_column('inventory_incomingproduct', 'new_base_price')
    ...
    models = {
        ...
        'inventory.ddt': {
            ...
            'shipping_address': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'shipping_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 27, 11, 14, 6, 521856)'})
        },
        'inventory.incomingproduct': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_base_price': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '3'}),
