...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PACustomer.cu'
        db.delete_column('people_pacustomer', 'cu')


    def backwards(self, orm):
        # Adding field 'PACustomer.cu'
        db.add_column('people_pacustomer', 'cu',
                      self.gf('django.db.models.fields.CharField')(default='000000', max_length=6, unique=True),
                      keep_default=False)
