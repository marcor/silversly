...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Customer', fields ['cf']
        db.delete_unique('people_customer', ['cf'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Customer', fields ['cf']
        db.create_unique('people_customer', ['cf'])
