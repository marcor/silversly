...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanyCustomer.sdi_code'
        db.alter_column('people_companycustomer', 'sdi_code', self.gf('django.db.models.fields.CharField')(max_length=7))

    def backwards(self, orm):

        # Changing field 'CompanyCustomer.sdi_code'
        db.alter_column('people_companycustomer', 'sdi_code', self.gf('django.db.models.fields.CharField')(max_length=6))
