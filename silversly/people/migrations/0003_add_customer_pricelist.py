...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customer.pricelist'
        db.add_column('people_customer', 'pricelist', self.gf('django.db.models.fields.related.ForeignKey')(default='Pubblico', to=orm['inventory.Pricelist']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Customer.pricelist'
        db.delete_column('people_customer', 'pricelist_id')
