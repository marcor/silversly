...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CompanyCustomer', fields ['bank']
        db.delete_unique('people_companycustomer', ['bank_id'])


        # Changing field 'CompanyCustomer.bank'
        db.alter_column('people_companycustomer', 'bank_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Bank'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'CompanyCustomer', fields ['bank']
        db.create_unique('people_companycustomer', ['bank_id'])
    ...
    models = {
        ...
        'people.companycustomer': {
            ...
            'bank': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.Bank']", 'null': 'True', 'blank': 'True'}),
            ...
            'sdi_code': ('django.db.models.fields.CharField', [], {'max_length': '7', 'blank': 'True'}),
