...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cart.suspended'
        db.add_column('sales_cart', 'suspended',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cart.suspended'
        db.delete_column('sales_cart', 'suspended')
    ...
    models = {
        ...
        'sales.ddt': {
            ...
            'shipping_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 14, 0, 0)'}),
        ...
        'sales.invoice': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 6, 14, 0, 0)'}),
