...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PAInvoice.refdate'
        db.add_column('sales_painvoice', 'refdate',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'PAInvoice.refdate'
        db.delete_column('sales_painvoice', 'refdate')
    ...
    models = {
        ...
        'sales.ddt': {
            ...
            'shipping_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 26, 0, 0)'}),
        ...
        'sales.invoice': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2016, 2, 26, 0, 0)'}),
        ...
        'sales.painvoice': {
            ...
            'refdate': ('django.db.models.fields.DateField', [], {'null': 'True'}),
