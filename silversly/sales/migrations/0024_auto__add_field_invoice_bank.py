...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sales_invoice', 'bank',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Bank'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        'sales.ddt': {
            ...
            'shipping_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 12, 19, 0, 0)'}),
            'year': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '18'})
        },
        'sales.invoice': {
            'Meta': {'ordering': "['-year', '-date', '-number']", 'object_name': 'Invoice', '_ormbases': ['sales.Receipt']},
            'bank': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.Bank']", 'null': 'True'}),
            'costs': ('common.models.FixedDecimalField', [], {'default': "'3.10'", 'max_digits': '7', 'decimal_places': '2'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2018, 12, 19, 0, 0)'}),
