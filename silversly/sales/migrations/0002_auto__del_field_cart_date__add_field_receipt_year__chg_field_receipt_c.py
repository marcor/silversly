...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Cart.date'
        db.delete_column('sales_cart', 'date')
        ...
        db.alter_column('sales_receipt', 'cart_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sales.Cart'], unique=True))

        # Adding unique constraint on 'Receipt', fields ['cart']
        db.create_unique('sales_receipt', ['cart_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Receipt', fields ['cart']
        db.delete_unique('sales_receipt', ['cart_id'])

        # User chose to not deal with backwards NULL issues for 'Cart.date'
        raise RuntimeError("Cannot reverse this migration. 'Cart.date' and its values cannot be restored.")

        # Deleting field 'Receipt.year'
        db.delete_column('sales_receipt', 'year')

        # Changing field 'Receipt.cart'
        db.alter_column('sales_receipt', 'cart_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sales.Cart']))
    ...
    models = {
        ...
        'people.retailcustomer': {
            ...
            'due': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
        ...
        'sales.ddt': {
            ...
            'shipping_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 8, 10, 2, 32, 672493)'})
        },
        'sales.invoice': {
        ...
        'sales.receipt': {
            'Meta': {'unique_together': "(('year', 'number'),)", 'object_name': 'Receipt'},
