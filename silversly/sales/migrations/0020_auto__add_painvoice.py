...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PAInvoice'
        db.create_table('sales_painvoice', (
            ('invoice_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sales.Invoice'], unique=True, primary_key=True)),
            ('cig', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('sales', ['PAInvoice'])


    def backwards(self, orm):
        # Deleting model 'PAInvoice'
        db.delete_table('sales_painvoice')
    ...
    models = {
        ...
        'sales.ddt': {
            ...
            'shipping_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 4, 0, 0)'}),
            'year': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '15'})
        },
        'sales.invoice': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 10, 4, 0, 0)'}),
        ...
        'sales.painvoice': {
            ...
            'cig': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
