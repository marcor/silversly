...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sales_cartitem', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Product'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CartItem.product'
        raise RuntimeError("Cannot reverse this migration. 'CartItem.product' and its values cannot be restored.")
