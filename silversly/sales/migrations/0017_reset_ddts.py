...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for ddt in orm.Ddt.objects.all():
                ddt.year = ddt.year - 1
                ddt.save()
    ...
    models = {
        ...
        'sales.ddt': {
            ...
            'shipping_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 9, 0, 0)'}),
        ...
        'sales.invoice': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 9, 0, 0)'}),
