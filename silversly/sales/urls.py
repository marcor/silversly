...
urlpatterns = patterns('sales.views',
    ...
    url(r'archivio/fattura/(\d+)/stampa$', 'export_invoice', name='print_invoice', kwargs={'format': 'pdf'}),
    url(r'archivio/fattura/(\d+)/stampa/no-ddt/$', 'export_invoice', name='print_unreferenced_invoice', kwargs={'format': 'pdf', 'reference_ddts': False }),
    url(r'archivio/fattura/(\d+)/esporta_xml$', 'export_invoice', name='xml_export', kwargs={'format': 'xml','reference_ddts': False}),
    url(r'archivio/ddt/(\d+)/$', 'show_ddt', name='show_ddt'),
    url(r'archivio/fattura/(\d+)/$', 'show_invoice', name='show_invoice'),
    url(r'archivio/ddt/annulla_ultimo/$', 'delete_ddt', name='delete_last_ddt'),
    url(r'archivio/fattura/annulla_ultima/$', 'delete_invoice', name='delete_last_invoice'),
    url(r'archivio/fattura/annulla_ultima_pa/$', 'delete_invoice', name='delete_last_painvoice', kwargs={'pa': True}),
)
