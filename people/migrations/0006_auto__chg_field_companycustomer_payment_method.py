...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompanyCustomer.payment_method'
        db.alter_column('people_companycustomer', 'payment_method', self.gf('django.db.models.fields.CharField')(max_length=4))

    def backwards(self, orm):

        # Changing field 'CompanyCustomer.payment_method'
        db.alter_column('people_companycustomer', 'payment_method', self.gf('django.db.models.fields.CharField')(max_length=50))
