...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompanyCustomer.sdi_code'
        db.add_column('people_companycustomer', 'sdi_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompanyCustomer.sdi_code'
        db.delete_column('people_companycustomer', 'sdi_code')
