...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.vat_rate'
        db.add_column('sales_invoice', 'vat_rate',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=21),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.vat_rate'
        db.delete_column('sales_invoice', 'vat_rate')
    ...
    models = {
        ...
        'sales.ddt': {
            ...
            'shipping_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 1, 0, 0)'}),
        ...
        'sales.invoice': {
            ...
            'vat_rate': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '21'}),
            'year': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '13'})
        },
        'sales.receipt': {
