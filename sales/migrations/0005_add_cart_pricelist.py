...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cart.pricelist'
        db.add_column('sales_cart', 'pricelist', self.gf('django.db.models.fields.related.ForeignKey')(default='Pricelist', to=orm['inventory.Pricelist']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cart.pricelist'
        db.delete_column('sales_cart', 'pricelist_id')
    ...
    models = {
        ...
        'sales.cart': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pricelist': ('django.db.models.fields.related.ForeignKey', [], {'default': "'Pricelist'", 'to': "orm['inventory.Pricelist']"}),
        ...
        'sales.ddt': {
            ...
            'shipping_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 20, 21, 9, 16, 317684)'}),
