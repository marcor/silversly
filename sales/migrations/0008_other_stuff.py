...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sales_invoice', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.date(2011, 5, 21), blank=True), keep_default=False)
    ...
    models = {
        ...
        'sales.ddt': {
            ...
            'shipping_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 21, 14, 15, 27, 902640)'}),
