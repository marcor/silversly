...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invoice.total_net'
        db.add_column('sales_invoice', 'total_net', self.gf('common.models.FixedDecimalField')(null=True, max_digits=8, decimal_places=2), keep_default=False)

        # Adding field 'Invoice.payed'
        db.add_column('sales_invoice', 'payed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invoice.total_net'
        db.delete_column('sales_invoice', 'total_net')

        # Deleting field 'Invoice.payed'
        db.delete_column('sales_invoice', 'payed')
    ...
    models = {
        ...
        'sales.cart': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pricelist': ('django.db.models.fields.related.ForeignKey', [], {'default': "'Pubblico'", 'to': "orm['inventory.Pricelist']"}),
            'rounded': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        'sales.cartitem': {
        ...
        'sales.ddt': {
            ...
            'shipping_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 23, 4, 18, 39, 343611)'}),
        ...
        'sales.invoice': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 6, 23, 4, 18, 39, 353710)'}),
