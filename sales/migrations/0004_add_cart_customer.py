...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('sales_cart', 'customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Customer'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cart.customer'
        db.delete_column('sales_cart', 'customer_id')
    ...
    models = {
        ...
        'sales.ddt': {
            ...
            'shipping_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 20, 14, 58, 56, 653116)'}),
