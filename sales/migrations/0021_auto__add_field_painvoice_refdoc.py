...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PAInvoice.refdoc'
        db.add_column('sales_painvoice', 'refdoc',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PAInvoice.refdoc'
        db.delete_column('sales_painvoice', 'refdoc')
