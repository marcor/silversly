...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cart.vat_rate'
        db.add_column('sales_cart', 'vat_rate',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=22),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cart.vat_rate'
        db.delete_column('sales_cart', 'vat_rate')
