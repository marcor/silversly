...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Supply.altprice'
        db.add_column('inventory_supply', 'altprice', self.gf('common.models.FixedDecimalField')(null=True, max_digits=8, decimal_places=3, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Supply.altprice'
        db.delete_column('inventory_supply', 'altprice')
